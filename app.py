...
st.title("Recommendations for Optical Eyeglass Frames Based")

tab1, tab2 = st.tabs(["Recommendations based on the results of face shape and gender", "All eyeglass frames"])
